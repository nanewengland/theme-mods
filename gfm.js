            ...
            var selectedValue = jQuery("#input_10_31").val();
             ...
             if ( dayOfWeek == 'Sunday' ) {
              ...
              if ( jQuery.inArray('4', formatsArray) > -1 ) {
                   jQuery('#choice_10_13_1').attr('checked', true);
              }
              // Open
              else if ( jQuery.inArray('17', formatsArray) > -1 ) {
                   jQuery('#choice_10_13_0').attr('checked', true);
              }
              ...
              jQuery("#input_10_20").val(data[0].train_lines);
              jQuery("#input_10_19").val(data[0].bus_lines);
